...
var _pre = __webpack_require__(/*! ./transform/pre */ "./src/collection/transform/pre.js");
...
class ResourceIDCollection {
  ...
  toArray(options, globalScopeCollection = this) {
    return (0, _pre2.default)(this.values(), options, globalScopeCollection);
  }
...
var _index = __webpack_require__(/*! ./transform/index */ "./src/collection/transform/index.js");
...
class ResourceCollection extends _id2.default {
  ...
  toArray(options, globalScopeCollection = this) {
    return (0, _index2.default)(this.values(), options, globalScopeCollection);
  }
...
/***/ "./src/collection/transform/include.js":
/*!*********************************************!*\
  !*** ./src/collection/transform/include.js ***!
  \*********************************************/
/*! no static exports found */
...
exports.default = (data, options, globalScopeCollection) => {
  return data.map(resourceObject => {
    const included = resourceObject.included();

    if ((0, _isNil2.default)(included)) {
      return null;
    }
...
var _pre = __webpack_require__(/*! ./pre */ "./src/collection/transform/pre.js");

var _pre2 = _interopRequireDefault(_pre);

var _include = __webpack_require__(/*! ./include */ "./src/collection/transform/include.js");
...
const postTransform = (data, options, globalScopeCollection) => {
  ...
  data = (0, _pre2.default)(data, options, globalScopeCollection);

  if ('include' in options) {
    data = (0, _include2.default)(data, options.include, globalScopeCollection);
  }
...
/***/ "./src/collection/transform/pre.js":
/*!*****************************************!*\
  !*** ./src/collection/transform/pre.js ***!
  \*****************************************/
/*! no static exports found */
...
function sort(data, options, globalScopeCollection) {
  ...
  options = options.map(rule => {
    ...
    if (!(0, _isNumber2.default)(rule[1])) {
...
function createBody(type, options, includeTypeOptions, fetched) {
...
exports.default = async function fetch(queries, action, type, options, ...args) {
  ...
  const body = (0, _createBody2.default)(type, options, includeTypeOptions, (await tree.resolve(null)));
...
class ResourceObject extends _id2.default {
  ...
  toJSON(options) {
    const data = (0, _post2.default)(this._value, this._options);
